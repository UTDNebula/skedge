...
async function fetchNebulaCourse(params: FetchCourseParameters): Promise<CourseInterface> | null {
  try {
...
async function fetchNebulaProfessor(params: FetchProfessorParameters): Promise<ProfessorInterface> | null {
  try {
...
async function fetchNebulaSections(params: FetchSectionParameters): Promise<SectionInterface[]> | null {
  try {
